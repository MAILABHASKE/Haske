...
export default {
  ...
  async handleSignOut() {
      if (this.user) {
        console.log('User is signed in:', this.user.email); // Debugging statement
        try {
          ...
          // Redirect to https://www.haske.online
          window.location.href = 'https://www.haske.online';
          console.log('Redirecting to https://www.haske.online'); // Debugging statement
    ...
    onAuthStateChanged(auth, (user) => {
      if (user) {
        ...
        this.user = null; // User is signed out
